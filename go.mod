...
// Modified by FlowSage: added github.com/chromedp/chromedp (browser automation).
// The `go` directive was raised from 1.25.0 to 1.26 because chromedp requires it.
